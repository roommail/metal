...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("PdfViewer.DragPinchManager, Xamarin.Android.PdfViewer", DragPinchManager.class, __md_methods);
	}


	public DragPinchManager ()
	{
		super ();
		if (getClass () == DragPinchManager.class)
			mono.android.TypeManager.Activate ("PdfViewer.DragPinchManager, Xamarin.Android.PdfViewer", "", this, new java.lang.Object[] {  });
	}
