...
/** @hide */
	...
	public RenderingHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == RenderingHandler.class)
			mono.android.TypeManager.Activate ("PdfViewer.RenderingHandler, Xamarin.Android.PdfViewer", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public RenderingHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == RenderingHandler.class)
			mono.android.TypeManager.Activate ("PdfViewer.RenderingHandler, Xamarin.Android.PdfViewer", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
